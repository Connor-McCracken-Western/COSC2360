...
selectVehicle.addEventListener("click", function(){
   let makeInf = make.options[make.selectedIndex].text;
   let modelInf = model.options[model.selectedIndex].text;
   let trimInf = trim.options[trim.selectedIndex].text;
   vehicle.innerText = makeInf + " " + modelInf + " " + trimInf;
})
